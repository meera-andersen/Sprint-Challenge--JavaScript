...
*/
let dinosaurs = [
  {"name": "Tyrannosaurus", "diet": "Carnivorous", "weight": "7000kg", "length": "12m", "timePeriod": "Late Cretaceous", roar(){return("RAWERSRARARWERSARARARRRR!")}},
  {"name": "Stegosauraus", "diet": "Herbivore", "weight": "2000kg", "length": "9m", "timePeriod": "Late Jurassic" },
  {"name": "Velociraptor", "diet": "Carnivorous", "weight": "15kg", "length": "1.8m", "timePeriod": "Late Cretaceous" }
];

// How much did tyrannosaurus weigh?
// console.log(`The T-rex weighs ${dinosaurs[0].weight}`);
...
// console.log(dinosaurs[1].timePeriod);
...
for(let i = 0; i < graduates.length; i++){
  if (graduates[i].university.includes("Uni" || "uni")){
...
zooAnimals.filter(function(currentValue){
    ...
    lowerPopulation.push(currentValue.animal_name);
  }
})
...
*/
const populationTotal = zooAnimals.reduce(function(populationTotal, currentValue){
  return populationTotal += currentValue.population;}, 0);
